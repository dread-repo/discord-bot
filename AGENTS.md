...
2. **Implement** per `tasks.md` — **one commit per task** after marking `[X]` (stage task files only; see [docs/agents/spec-kit-implement-commits.md](docs/agents/spec-kit-implement-commits.md) and [.specify/extensions/git-task-commit/README.md](.specify/extensions/git-task-commit/README.md))
